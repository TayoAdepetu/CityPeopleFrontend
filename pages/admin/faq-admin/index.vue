<template>
    <!--This page is for admin and superadmin to manage Faqs section-->
    <div>
        <div>
    <thead>
      <tr>
  ...
  <form @submit.prevent="editPost()" class="selectBank normalInput2 fullWidth form-control mt-2">         
      ...
      <div>
          <div class="form-group">
            <textarea v-model="selectedPost.question" class="form-control" id="title" required></textarea>
          </div>

          <div class="form-group">
            <textarea type="text" v-model="selectedPost.answer" class="form-control" id="description" required></textarea>
          </div>
  ...
  export default { 
    ...
    const { data } = await this.$axios.put(`/api/auth/update-faq/${this.selectedPost.id}`,
